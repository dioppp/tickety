...
<body>
    ...
    <div class="container grid grid-cols-2 gap-6">
        <div>
            <img src="{{ asset('images/products/product1.jpg') }}" alt="product" class="w-full">
            <div class="grid grid-cols-5 gap-4 mt-4">
                <img src="{{ asset('images/products/product2.jpg') }}" alt="product2"
                    class="w-full cursor-pointer border border-primary">
                <img src="{{ asset('images/products/product3.jpg') }}" alt="product2" class="w-full cursor-pointer border">
                <img src="{{ asset('images/products/product4.jpg') }}" alt="product2" class="w-full cursor-pointer border">
                <img src="{{ asset('images/products/product5.jpg') }}" alt="product2" class="w-full cursor-pointer border">
                <img src="{{ asset('images/products/product6.jpg') }}" alt="product2" class="w-full cursor-pointer border">
            </div>
        </div>
